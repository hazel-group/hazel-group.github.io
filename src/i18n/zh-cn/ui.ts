...
export default {
	...
	'home.nacos.edge.1.description': 'Spring Cloud Alibaba 作为一站式的微服务构建方案，用户只需要添加一些注解和少量配置，就可以通过阿里中间件来迅速搭建分布式应用系统。',
	'home.nacos.edge.2.title': '扩展性强',
	'home.nacos.edge.2.description': 'Spring Cloud Alibaba 基于 Spring Cloud 微服务解决方案规范，可便捷地对其中的组件进行扩展和替换。',
	'home.nacos.edge.3.title': '生产等级',
	'home.nacos.edge.3.description': '核心组件都经过过阿里巴巴多年双十一洪峰考验，成熟稳定。',
	'home.nacos.edge.4.title': '能力全面',
	'home.nacos.edge.4.description': '针对微服务架构中的服务注册与发现、分布式消息、微服务限流降级、分布式事务和微服务治理等重要领域，都提供了对应解决方案。',
