...
export default {
	...
	'home.website.edge.title': 'AI 网关',
	'home.website.edge.subtitle': '为开发者提供了一站式的AI插件集和增强后端模型调度处理能力，使得AI与网关的集成更加便捷和高效。',
	'home.website.edge.1.title': '易于扩展',
	'home.website.edge.1.description': '提供丰富的官方插件库，涵盖AI、流量管理、安全防护等常用功能，满足90%以上的业务场景需求。支持Wasm、Lua、进程外三种插件类型，支持插件的热插拔，多种作用域和自定义扩展。',
	'home.website.edge.2.title': '遵循标准',
	'home.website.edge.2.description': '遵循Ingress、Gateway API 和 Istio API标准，可一键支持基于以上技术选型的其他网关平滑迁移。',
	'home.website.edge.3.title': '安全防护',
	'home.website.edge.3.description': '提供JWT、OIDC、自定义认证鉴权，深度集成开源Web应用防火墙，使企业快速具备安全防护能力。',
	'home.website.edge.4.title': '生产等级',
	'home.website.edge.4.description': '脱胎于阿里巴巴生产验证的内部产品，历经双十一洪荒流量的锤炼，企业级产品SLA高达99.99%。',
	'home.open.ecosystem.title': '社区生态集成',
	'home.open.ecosystem.subtitle': '在Istio和Envoy的助力下，highress实现了流量网关、微服务网关和安全网关三重网关架构的集成，从而大大降低了部署和运维成本。',
	'home.ai.structure.title': 'AI 网关架构',
