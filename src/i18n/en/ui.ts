...
export default {
	...
	'home.website.edge.4.title': 'Safety Protection',
	'home.website.edge.4.description': 'Provides JWT, OIDC, custom authentication and authorization, and deeply integrates with open-source web application firewalls, allowing enterprises to quickly achieve security protection capabilities.',
