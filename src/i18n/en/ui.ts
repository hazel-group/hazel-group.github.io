export default {
	...
	'home.website.edge.title': 'AI Gateway',
	'home.website.edge.subtitle': 'Provides developers with a comprehensive AI plugin suite and enhanced backend model orchestration capabilities, making the integration of AI and gateways more convenient and efficient.',
	'home.website.edge.1.title': 'Easy to scale',
	'home.website.edge.1.description': 'Provides a rich official plugin library covering commonly used functions such as AI, traffic management, and security protection, meeting the needs of over 90% of business scenarios. Supports three types of plugins: Wasm, Lua, and out-of-process, with hot-plug capability, multiple scopes, and custom extensions.',
	'home.website.edge.2.title': 'Follow standards',
	'home.website.edge.2.description': 'Adheres to Ingress, Gateway API, and Istio API standards, enabling seamless migration of other gateways based on the above technologies with a single click.',
	'home.website.edge.3.title': 'Safety Protection',
	'home.website.edge.3.description': 'Provides JWT, OIDC, custom authentication and authorization, and deeply integrates with open-source web application firewalls, allowing enterprises to quickly achieve security protection capabilities.',
	'home.website.edge.4.title': 'Production grade',
	'home.website.edge.4.description': "Originating from Alibaba's production-verified internal products and tested by the massive traffic of Double 11, the enterprise-level product achieves an SLA of up to 99.99%.",
	'home.open.ecosystem.title': 'Open Ecosystem Integration',
	...
	'home.ai.structure.title': 'AI Gateway Structure',
