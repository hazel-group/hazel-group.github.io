...
"2023/en/user-guide/schedulerx/overview.md": {
	id: "2023/en/user-guide/schedulerx/overview.md";
  slug: "2023/en/user-guide/schedulerx/overview";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"2023/en/user-guide/schedulerx/quick-start.md": {
	id: "2023/en/user-guide/schedulerx/quick-start.md";
  slug: "2023/en/user-guide/schedulerx/quick-start";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
...
"2023/zh-cn/user-guide/schedulerx/overview.md": {
	id: "2023/zh-cn/user-guide/schedulerx/overview.md";
  slug: "2023/zh-cn/user-guide/schedulerx/overview";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"2023/zh-cn/user-guide/schedulerx/quick-start.md": {
	id: "2023/zh-cn/user-guide/schedulerx/quick-start.md";
  slug: "2023/zh-cn/user-guide/schedulerx/quick-start";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
